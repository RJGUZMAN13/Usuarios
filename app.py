...
# ---------------- FIREBASE ----------------
cred_path = os.path.join(base_path, "firebase")
...
# ---------------- CONFIG ----------------
img_path = os.path.join(base_path, "imagenes", "logoo.png")
st.set_page_config(
...
# Variable global fuera de Streamlit
_browser_opened = False

if __name__ == "__main__":
    if not _browser_opened:
        threading.Timer(1, lambda: webbrowser.open("http://localhost:8501")).start()
